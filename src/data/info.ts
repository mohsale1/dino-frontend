...
export const COMPANY_INFO = {
  ...
  description: 'Streamline operations with digital menus and ordering',
...
export const CORE_FEATURES = [
  ...
  },
  {
    ...
    description: 'Contactless browsing and ordering through QR codes',
    icon: QrCode,
    color: 'secondary',
...
export const TESTIMONIALS = [
  {
    ...
    location: 'Mumbai',
    rating: 5,
    text: 'Dino transformed our business operations. Orders are faster, more accurate, and our customers love the digital experience.',
    comment: 'Dino transformed our business operations. Orders are faster, more accurate, and our customers love the digital experience.',
  ...
  },
  {
    ...
    restaurant: 'Urban Lounge Bar',
    location: 'Bangalore',
    rating: 5,
    text: 'Operations are so much smoother now. Real-time updates help us serve customers faster and reduce wait times significantly.',
    comment: 'Operations are so much smoother now. Real-time updates help us serve customers faster and reduce wait times significantly.',
...
export const FAQS = [
  {
    ...
    answer: 'You can be up and running within 24 hours. Our team will help you set up your digital catalog and train your staff.'
  },
  {
    question: 'Do customers need to download an app?',
    answer: 'No! Customers simply scan a QR code and access your catalog through their web browser. No app download required.'
  },
  {
    question: 'Can we customize the design?',
    answer: 'Yes, you can fully customize your catalog with your branding, colors, and layout to match your business style.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes, we integrate with most popular POS and management systems. Our team will help you set up the integration.'
  }
] as const;
...
export const CONTENT = {
  ...
  HERO_SUBTITLE: 'Digital catalog, QR ordering, and real-time management',
  ...
  hero: {
    ...
    subtitle: 'Digital catalog, QR ordering, and real-time management',
    description: 'Streamline your business with our comprehensive digital solution. From contactless ordering to real-time analytics, we help you deliver exceptional customer experiences.',
    cta: {
  ...
  features: {
    ...
    subtitle: 'Comprehensive tools designed for modern businesses'
  },

  benefits: {
    title: 'Why Choose Dino?',
    subtitle: 'Join hundreds of businesses already transforming their operations',
    stats: {
      processing: {
        value: '3x',
  ...
  contact: {
    ...
    subtitle: 'Contact us today and transform your business experience'
  }
} as const;
