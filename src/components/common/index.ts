...
export { default as ErrorBoundary } from '../errors/boundaries/GlobalErrorBoundary';
...
export { default as WorkspaceErrorBoundary } from '../errors/boundaries/WorkspaceErrorBoundary';