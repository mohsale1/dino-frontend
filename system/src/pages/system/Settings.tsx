...
const Settings: React.FC = () => {
  // General
  const [systemName,               setSystemName]               = useState<string>(APP_CONFIG.SYSTEM_NAME);
  const [supportEmail,             setSupportEmail]             = useState<string>(APP_CONFIG.SUPPORT_EMAIL);
  const [adminEmail,               setAdminEmail]               = useState<string>(APP_CONFIG.ADMIN_EMAIL);
  ...
  const [smtpUsername, setSmtpUsername] = useState<string>(APP_CONFIG.NOREPLY_EMAIL);
