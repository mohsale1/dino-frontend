      ...
      >
        <Container maxWidth="lg">
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 1.5 }}>
            ...
            <Typography variant="body2" sx={{ textAlign: 'center', color: '#64748b', fontSize: '0.875rem' }}>
    ...
    >
      ...
      <Box
        sx={{
          ...
          height: '3px',
          background: 'linear-gradient(90deg, transparent, #1976D2 30%, #42A5F5 70%, transparent)',
          opacity: 0.5,
        }}
      />
        ...
        <Grid container spacing={{ xs: 5, md: 6 }}>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 0.75 }}>
              ...
              <Typography variant="h6" fontWeight={700} sx={{ color: '#ffffff', lineHeight: 1 }}>
            ...
            <Typography
              variant="body2"
              sx={{ color: '#94a3b8', fontSize: '0.875rem', lineHeight: 1.75 }}
            >
          ...
          <Grid item xs={12} sm={6} md={4}>
            <Typography
              sx={{
                ...
                letterSpacing: '0.08em', textTransform: 'uppercase', mb: 2.5,
              }}
            >
              Platform
            </Typography>
              ...
              {NAV_LINKS.map((item) => (
                <Box
                  ...
                  sx={{
                    ...
                    '& .link-arrow': { opacity: 0.3, transition: 'opacity 0.2s ease' },
                    '&:hover': {
                      color: '#42A5F5',
                ...
                >
                  <ChevronRight className="link-arrow" sx={{ fontSize: 14, color: 'inherit' }} />
                  {item.label}
                </Box>
              ))}
            </Box>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                {contactInfo.email && (
                  <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 1.5 }}>
                    <Email sx={{ fontSize: 16, color: '#1976D2', mt: 0.25, flexShrink: 0 }} />
                    <Link
                      href={`mailto:${contactInfo.email}`}
                      underline="none"
                      sx={{ color: '#64748b', fontSize: '0.875rem', lineHeight: 1.6, transition: 'color 0.2s ease', '&:hover': { color: '#42A5F5' } }}
                    >
                      {contactInfo.email}
                    </Link>
                  </Box>
                ...
                {contactInfo.phone && (
                  <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 1.5 }}>
                    <Phone sx={{ fontSize: 16, color: '#1976D2', mt: 0.25, flexShrink: 0 }} />
                    <Link
                ...
                {(contactInfo.address || contactInfo.city) && (
                  <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 1.5 }}>
                    <LocationOn sx={{ fontSize: 16, color: '#1976D2', mt: 0.25, flexShrink: 0 }} />
                    <Typography variant="body2" sx={{ color: '#64748b', fontSize: '0.875rem', lineHeight: 1.6 }}>
                      ...
                      {contactInfo.country && (<><br />{contactInfo.country}</>)}
                    </Typography>
                  </Box>
                )}
              </Box>
