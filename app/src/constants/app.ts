...
export const APP_CONFIG = {
  ...
  POWERED_BY_POS: 'Powered by Dino POS',
} as const;
...
export const ROLE_COLORS = {
  Owner: {
    primary: '#1976D2',
    secondary: '#42A5F5',
    gradient: 'linear-gradient(135deg,#1565C0 0%,#1976D2 45%,#1E88E5 100%)',
    glowA: 'rgba(25,118,210,0.28)',
    glowB: 'rgba(66,165,245,0.18)',
    chipText: '#ffffff',
    statLabel: 'rgba(255,255,255,0.72)',
    statValue: '#ffffff',
  },
  Manager: {
    primary: '#1976D2',
...
// Role Colors (hex) — for badges, chips, and UI indicators
...
// User Status Colors (hex)
export const USER_STATUS_COLORS: Record<string, string> = {
  active: '#10b981',
  inactive: '#6b7280',
};

// Threshold for flagging a user account as "new" (in days)
