...
export const cacheUtils = {
  ...
  /**
   * Preload critical data (no-op in dino-system)
   */
  preloadCriticalData: async (_userId: string, _venueId?: string): Promise<void> => {
    // Not applicable in the system admin service
  },
};
